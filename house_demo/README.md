...
## Meet Tiko, the On-Site Engineer

To keep the demo light-hearted, the files now ship with a fictional project lead: **Tiko the Engineer**. When you import the parts, imagine Tiko pacing around the virtual job site muttering, “Constraints are just friendly suggestions!” He claims the gable roof angle was inspired by his favourite pizza slice and insists every assembly mates itself if you compliment it first. Feel free to invent your own Tiko-approved design notes when showcasing the model.
